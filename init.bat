...
cecho {\n}
	...
	if %Choose% EQU 3 qemu-system-i386 -drive format=raw,file=C:\Projects\KiddieOS_Development\ISO\KiddieOS.vhd -m 1000 -boot order=dc -cpu core2duo -vga std -accel tcg,thread=single -smp 1 -audiodev id=sdl,driver=sdl -machine pcspk-audiodev=sdl
